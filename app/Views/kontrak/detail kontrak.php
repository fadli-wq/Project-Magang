...
<div class="container mt-4">
    <h2>Detail Kontrak E-Katalog</h2>
    ...
    <div class="card p-3 mt-3">
        ...
        <h5>Jenis Kontrak:</h5>
        <ul>
            <?php if (!empty($kontrak['nomor_sp'])) : ?>
                <li><strong>Nomor SP:</strong> <?= $kontrak['nomor_sp'] ?> (<?= $kontrak['tgl_sp'] ?>)</li>
            <?php endif; ?>
            ...
            <?php if (!empty($kontrak['nomor_spp'])) : ?>
                <li><strong>Nomor SPP:</strong> <?= $kontrak['nomor_spp'] ?> (<?= $kontrak['tgl_spp'] ?>)</li>
            <?php endif; ?>
        </ul>
    </div>
    ...
    <a href="<?= base_url('kontrak/e-katalog/daftar_kontrak_e_katalog') ?>" class="btn btn-secondary mt-3">Kembali</a>
</div>
