...
<div class="container mt-4">
    ...
    <div class="card p-3 mt-3">
        ...
        <h5>Jenis Kontrak:</h5>
        <ul>
            <?php if (!empty($kontrak['nomor_perjanjian'])) : ?>
                <li><strong>Nomor SP:</strong> <?= $kontrak['nomor_perjanjian'] ?> (<?= $kontrak['tgl_perjanjian'] ?>)</li>
            <?php endif; ?>
    ...
    <a href="<?= base_url('kontrak/tender/daftar_kontrak_tender') ?>" class="btn btn-secondary mt-3">Kembali</a>
</div>
