            ...
            <form action="<?= base_url('kontrak/e-katalog/pembayaran/termin_simpan_session') ?>" method="post">
                ...
                <div class="mb-3">
                    ...
                    <select name="metode" class="form-control" required>
                        <option value="Sekaligus" <?= (session()->get('pembayaran.metode') == 'Sekaligus') ? 'selected' : '' ?>>Sekaligus</option>
                        <option value="Termin" <?= (session()->get('pembayaran.metode') == 'Termin') ? 'selected' : '' ?>>Termin</option>
                    </select>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="sumber_dana" class="form-control" placeholder="Masukkan Sumber Dana" value="<?= session()->get('pembayaran.sumber_dana') ?? '' ?>" required>
                </div>
