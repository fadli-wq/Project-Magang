...
<div class="d-flex">
    ...
    <div class="container-fluid p-4">
        ...
        <form action="<?= base_url('kontrak/e-katalog/pembayaran/termin/item/submit') ?>" method="post">
          ...
          <input type="text" name="kode_item" class="form-control" value="<?= session()->get('item.kode_item') ?? '' ?>" required>
          <label>Nama Item</label>
          <input type="text" name="nama_item" class="form-control" value="<?= session()->get('item.nama_item') ?? '' ?>" required>
